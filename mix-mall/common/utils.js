...
export function checkAddCld(scannedCldList, VCDetail) {
...
export function checkAddCldStampId(scannedCldList, VCDetailId) {
	var alreadyHave = false;
	if (scannedCldList.length == 0) {
...
export function formatPolylines(curPolyline) {
